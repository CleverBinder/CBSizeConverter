...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/CBSizeConverter"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "morten jeppesen" => "mkj@cleverbinder.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/CBSizeConverter.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'CBSizeConverter' => ['Pod/Assets/*.png']
  }
